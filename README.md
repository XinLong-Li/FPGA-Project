...
2. Upload files to the board. Open a Windows Terminal and run the following command. The Password is `ee2162023`.
   ```
    # upload a file folder
    scp -r -P 12222 C:\Users\lxl\Documents\vitis_hls_ws\Project\Project\board\ root@10.19.129.51:/root/lixl

    # upload a single file to board
    scp -P 12222 C:\Users\lxl\Documents\vitis_hls_ws\Project\Project\ORB_accel.bit root@10.19.129.51:/root/lixl\board
   ```
3. Use SSH tools to connect to the board. The Password is `ee2162023`.
    ```
    ssh -p 12222 root@10.19.129.51
    ```
4. Run on board
    ```
