...
set id 84
set name ORB_accel_udiv_23ns_11ns_23_27_1
...
set id 85
set name ORB_accel_urem_23ns_11ns_23_27_1
...
set id 119
set name ORB_accel_am_addmul_11ns_4ns_11ns_23_4_1
...
set out_width 23
set exp (i0+i1)*i2
set arg_lists {i0 {11 0 +} i1 {4 0 +} s {12 0 +} i2 {11 0 +} p {23 0 +} c_expval {c} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set id 120
set name ORB_accel_mul_mul_8ns_11ns_18_4_1
set corename simcore_mul
set op mul
set stage_num 4
set max_latency -1
...
set out_width 18
set exp i0*i1
set arg_lists {i0 {8 0 +} i1 {11 0 +} p {18 0 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mul] == "ap_gen_simcore_mul"} {
eval "ap_gen_simcore_mul { \
...
set ID 135
set hasByteEnable 0
set MemName ORB_accel_process_blur_8_0_1080_1920_1_s_line_buffer_val_V_1
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_img_in \
    op interface \
    ports { img_in_dout { I 8 vector } img_in_empty_n { I 1 bit } img_in_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_img_out \
    op interface \
    ports { img_out_din { O 8 vector } img_out_full_n { I 1 bit } img_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_blur_out \
    op interface \
    ports { blur_out_din { O 8 vector } blur_out_full_n { I 1 bit } blur_out_write { O 1 bit } } \
} "
}
