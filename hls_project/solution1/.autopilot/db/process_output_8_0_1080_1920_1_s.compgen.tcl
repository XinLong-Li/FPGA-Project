...
set id 1596
set name ORB_accel_mac_muladd_8ns_8ns_15ns_15_4_1
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { dst_TDATA { O 296 vector } dst_TREADY { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { dst_TVALID { O 1 bit } dst_TDEST { O 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename cntTree \
    op interface \
    ports { cntTree_address0 { O 8 vector } cntTree_ce0 { O 1 bit } cntTree_we0 { O 1 bit } cntTree_d0 { O 32 vector } cntTree_address1 { O 8 vector } cntTree_ce1 { O 1 bit } cntTree_q1 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename idxTree \
    op interface \
    ports { idxTree_address0 { O 15 vector } idxTree_ce0 { O 1 bit } idxTree_we0 { O 1 bit } idxTree_d0 { O 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_src \
    op interface \
    ports { src_dout { I 512 vector } src_empty_n { I 1 bit } src_read { O 1 bit } } \
} "
}
