...
`define TV_OUT_dst_TDATA "./impl_rtl.ORB_accel.autotvout_dst_V_data_V.dat"
`define EGRESS_STATUS_dst_TDATA "./stream_egress_status_dst_V_data_V.dat"
`define TV_OUT_dst_TKEEP "./impl_rtl.ORB_accel.autotvout_dst_V_keep_V.dat"
`define EGRESS_STATUS_dst_TKEEP "./stream_egress_status_dst_V_keep_V.dat"
`define TV_OUT_dst_TSTRB "./impl_rtl.ORB_accel.autotvout_dst_V_strb_V.dat"
`define EGRESS_STATUS_dst_TSTRB "./stream_egress_status_dst_V_strb_V.dat"
`define TV_OUT_dst_TUSER "./impl_rtl.ORB_accel.autotvout_dst_V_user_V.dat"
`define EGRESS_STATUS_dst_TUSER "./stream_egress_status_dst_V_user_V.dat"
`define TV_OUT_dst_TLAST "./impl_rtl.ORB_accel.autotvout_dst_V_last_V.dat"
`define EGRESS_STATUS_dst_TLAST "./stream_egress_status_dst_V_last_V.dat"
`define TV_OUT_dst_TID "./impl_rtl.ORB_accel.autotvout_dst_V_id_V.dat"
`define EGRESS_STATUS_dst_TID "./stream_egress_status_dst_V_id_V.dat"
`define TV_OUT_dst_TDEST "./impl_rtl.ORB_accel.autotvout_dst_V_dest_V.dat"
`define EGRESS_STATUS_dst_TDEST "./stream_egress_status_dst_V_dest_V.dat"
