...
`define TV_IN_src_TDATA "./c.ORB_accel.autotvin_src_V_data_V.dat"
`define INGRESS_STATUS_src_TDATA "./stream_ingress_status_src_V_data_V.dat"
`define TV_IN_src_TKEEP "./c.ORB_accel.autotvin_src_V_keep_V.dat"
`define INGRESS_STATUS_src_TKEEP "./stream_ingress_status_src_V_keep_V.dat"
`define TV_IN_src_TSTRB "./c.ORB_accel.autotvin_src_V_strb_V.dat"
`define INGRESS_STATUS_src_TSTRB "./stream_ingress_status_src_V_strb_V.dat"
`define TV_IN_src_TUSER "./c.ORB_accel.autotvin_src_V_user_V.dat"
`define INGRESS_STATUS_src_TUSER "./stream_ingress_status_src_V_user_V.dat"
`define TV_IN_src_TLAST "./c.ORB_accel.autotvin_src_V_last_V.dat"
`define INGRESS_STATUS_src_TLAST "./stream_ingress_status_src_V_last_V.dat"
`define TV_IN_src_TID "./c.ORB_accel.autotvin_src_V_id_V.dat"
`define INGRESS_STATUS_src_TID "./stream_ingress_status_src_V_id_V.dat"
`define TV_IN_src_TDEST "./c.ORB_accel.autotvin_src_V_dest_V.dat"
`define INGRESS_STATUS_src_TDEST "./stream_ingress_status_src_V_dest_V.dat"
