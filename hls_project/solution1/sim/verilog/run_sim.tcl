...
if {[file isfile ORB_accel.autotvin.dat]} {
	file delete -force ORB_accel.autotvin.dat
}

if {[file isfile ORB_accel.autotvout.dat]} {
	file delete -force ORB_accel.autotvout.dat
}
