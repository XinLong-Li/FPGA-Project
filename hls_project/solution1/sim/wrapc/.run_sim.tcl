...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "ORB_accel.autotvin.dat"
	set constFileTvOut       "ORB_accel.autotvout.dat"
	set constFileHdlTvIn     "ORB_accel.autohdltvin.dat"
	set constFileHdlTvOut    "ORB_accel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
