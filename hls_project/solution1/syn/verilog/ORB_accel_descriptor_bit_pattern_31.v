...
// ==============================================================
`timescale 1 ns / 1 ps
module ORB_accel_descriptor_bit_pattern_31_rom (
...
initial begin
    $readmemh("./ORB_accel_descriptor_bit_pattern_31_rom.dat", ram0);
    $readmemh("./ORB_accel_descriptor_bit_pattern_31_rom.dat", ram1);
    $readmemh("./ORB_accel_descriptor_bit_pattern_31_rom.dat", ram2);
    $readmemh("./ORB_accel_descriptor_bit_pattern_31_rom.dat", ram3);
    $readmemh("./ORB_accel_descriptor_bit_pattern_31_rom.dat", ram4);
    $readmemh("./ORB_accel_descriptor_bit_pattern_31_rom.dat", ram5);
    $readmemh("./ORB_accel_descriptor_bit_pattern_31_rom.dat", ram6);
    $readmemh("./ORB_accel_descriptor_bit_pattern_31_rom.dat", ram7);
    $readmemh("./ORB_accel_descriptor_bit_pattern_31_rom.dat", ram8);
    $readmemh("./ORB_accel_descriptor_bit_pattern_31_rom.dat", ram9);
    $readmemh("./ORB_accel_descriptor_bit_pattern_31_rom.dat", ram10);
    $readmemh("./ORB_accel_descriptor_bit_pattern_31_rom.dat", ram11);
    $readmemh("./ORB_accel_descriptor_bit_pattern_31_rom.dat", ram12);
    $readmemh("./ORB_accel_descriptor_bit_pattern_31_rom.dat", ram13);
    $readmemh("./ORB_accel_descriptor_bit_pattern_31_rom.dat", ram14);
    $readmemh("./ORB_accel_descriptor_bit_pattern_31_rom.dat", ram15);
end
...
`timescale 1 ns / 1 ps
module ORB_accel_descriptor_bit_pattern_31(
    reset,
    clk,
    address0,
    ce0,
...
ORB_accel_descriptor_bit_pattern_31_rom ORB_accel_descriptor_bit_pattern_31_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
