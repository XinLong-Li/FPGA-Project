...
entity ORB_accel_xfUDivResize is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of ORB_accel_xfUDivResize is 
...
attribute shreg_extract : string;
    ...
    signal grp_fu_28_p0 : STD_LOGIC_VECTOR (42 downto 0);
    signal grp_fu_28_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_fu_28_p2 : STD_LOGIC_VECTOR (42 downto 0);
    signal ap_CS_fsm_state47 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state47 : signal is "none";
    signal grp_fu_28_ap_start : STD_LOGIC;
    signal grp_fu_28_ap_done : STD_LOGIC;
    signal zext_ln160_1_fu_34_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal grp_fu_28_p10 : STD_LOGIC_VECTOR (42 downto 0);
    signal ap_ce_reg : STD_LOGIC;

    component ORB_accel_udiv_43ns_16ns_43_47_seq_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    udiv_43ns_16ns_43_47_seq_1_U42 : component ORB_accel_udiv_43ns_16ns_43_47_seq_1
    generic map (
        ID => 1,
        NUM_STAGE => 47,
        din0_WIDTH => 43,
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_const_logic_1 = ap_CS_fsm_state47)) then 
                                        ap_return_preg(42 downto 0) <= zext_ln160_1_fu_34_p1(42 downto 0);
                end if; 
            end if;
        end if;
    end process;

    ap_return_preg(63 downto 43) <= "000000000000000000000";
    ...
    ap_return_assign_proc : process(ap_CS_fsm_state47, zext_ln160_1_fu_34_p1, ap_return_preg)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state47)) then 
    ...
    grp_fu_28_p0 <= in_n(43 - 1 downto 0);
    grp_fu_28_p1 <= grp_fu_28_p10(16 - 1 downto 0);
    grp_fu_28_p10 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(in_d),43));
    zext_ln160_1_fu_34_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(grp_fu_28_p2),64));
end behav;
