...
HD_PWD='C:/Users/lxl/Documents/vitis_hls_ws/Project/Project/vivado_project/ORB_accel.runs/ORB_accel_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ORB_accel_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ORB_accel_auto_pc_0.tcl
