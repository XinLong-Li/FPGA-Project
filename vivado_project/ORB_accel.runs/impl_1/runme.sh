...
HD_PWD='C:/Users/lxl/Documents/vitis_hls_ws/Project/Project/vivado_project/ORB_accel.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ORB_accel_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ORB_accel_wrapper.tcl -notrace
