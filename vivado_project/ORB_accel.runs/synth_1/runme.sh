...
HD_PWD='C:/Users/lxl/Documents/vitis_hls_ws/Project/Project/vivado_project/ORB_accel.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ORB_accel_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ORB_accel_wrapper.tcl
